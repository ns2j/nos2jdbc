...
import org.seasar.extension.jdbc.gen.dialect.MysqlGenDialect;
...
class GenerateTableTest {
     ...
     */
    @Test
    void testCreate_singleId() throws Exception {
        ...
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/create-table.ftl", "UTF-8", false);
        generator.generate(context);
        String path = getClass().getName().replace(".", "/") + "_Create_singleId.txt";
     ...
     */
    @Test
    void testCreate_compositeId() throws Exception {
        ColumnDesc no = new ColumnDesc();
        no.setName("no");
        no.setDefinition("integer");
        no.setNullable(false);
        ...
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/create-table.ftl", "UTF-8", false);
        generator.generate(context);
        String path = getClass().getName().replace(".", "/") + "_Create_compositeId.txt";
        assertEquals(TextUtil.readUTF8(path), generator.getResult());
    }
     ...
     */
    @Test
    void testCreate_noId() throws Exception {
        ColumnDesc no = new ColumnDesc();
        no.setName("no");
        no.setDefinition("integer");
        no.setNullable(true);
        ...
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/create-table.ftl", "UTF-8", false);
        generator.generate(context);
        String path = getClass().getName().replace(".", "/") + "_Create_noId.txt";
        assertEquals(TextUtil.readUTF8(path), generator.getResult());
    }
     ...
     */
    @Test
    void testCreate_tableOption() throws Exception {
        ColumnDesc no = new ColumnDesc();
        no.setName("no");
        no.setDefinition("integer");
        no.setIdentity(true);
        ...
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/create-table.ftl", "UTF-8", false);
        generator.generate(context);
        String path = getClass().getName().replace(".", "/") + "_Create_tableOption.txt";
        assertEquals(TextUtil.readUTF8(path), generator.getResult());
    }
     ...
     */
    @Test
    void testCreate_commentOn() throws Exception {
        ColumnDesc no = new ColumnDesc();
        no.setName("no");
        no.setDefinition("integer");
        no.setComment("番号カラム");
        ...
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/create-table.ftl", "UTF-8", false);
        generator.generate(context);
        String path = getClass().getName().replace(".", "/") + "_Create_commentOn.txt";
        assertEquals(TextUtil.readUTF8(path), generator.getResult());
    }
     ...
     */
    @Test
    void testCreate_commentInCreateTable() throws Exception {
        ColumnDesc no = new ColumnDesc();
        no.setName("no");
        no.setDefinition("integer");
        no.setComment("番号カラム");
        ...
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/create-table.ftl", "UTF-8", false);
        generator.generate(context);
        String path = getClass().getName().replace(".", "/") + "_Create_commentInCreateTable.txt";
        assertEquals(TextUtil.readUTF8(path), generator.getResult());
    }
    ...
    void testDrop() throws Exception {
        ...
        TableModelFactory factory = new TableModelFactory(new MssqlGenDialect(), dataSource, SqlIdentifierCaseType.ORIGINALCASE, SqlKeywordCaseType.ORIGINALCASE, ';', null, false);
        TableModel model = factory.getTableModel(tableDesc);
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/drop-table.ftl", "UTF-8", false);
        generator.generate(context);
