...
class GenerateEntityTest {
    ...
    void testSingleId() throws Exception {
        ...
        GenerationContext context = new GenerationContext(model, new File("file"), "java/entity.ftl", "UTF-8", false);
    ...
    void testSingleIdAssociation() throws Exception {
        ...
        context = new GenerationContext(model, new File("file"), "java/entity.ftl", "UTF-8", false);
        generator.generate(context);
