...
import org.seasar.extension.jdbc.gen.data.DumpFileWriter;
...
class DumpFileWriterTest {
    ...
    public void setUp() throws Exception {
        ...
        dumpFileWriter = new DumpFileWriter(new File("file"), tableDesc, new StandardGenDialect(), "UTF-8", ',') {
     ...
     */
    @Test
    void testWriteHeaderOnly() throws Exception {
        dumpFileWriter.writeHeaderOnly();
        bufferedWriter.flush();
        assertEquals(1, dumpFileWriter.getLineNumber());
        assertEquals("\"aaa\",\"bbb\",\"ccc\"" + separator, stringWriter.toString());
    }
     ...
     */
    @Test
    void testWrite_javaColumn_gt_dbColumn() throws Exception {
        ...
        assertEquals("\"aaa\",\"bbb\",\"ccc\"" + separator + "\"hoge\",,\"100\"" + separator + "\"f\"\"oo\",,\"200\"" + separator, stringWriter.toString());
    }
     ...
     */
    @Test
    void testWriteHeader_javaColumn_lt_dbColumn() throws Exception {
        MockColumnMetaData columnMetaData1 = new MockColumnMetaData();
        columnMetaData1.setColumnLabel("aaa");
        MockColumnMetaData columnMetaData2 = new MockColumnMetaData();
        ...
        bufferedWriter.flush();
        assertEquals(3, dumpFileWriter.getLineNumber());
        assertEquals("\"aaa\",\"bbb\",\"ccc\"" + separator + "\"hoge\",\"bar\",\"100\"" + separator + "\"f\"\"oo\",\"baz\",\"200\"" + separator, stringWriter.toString());
    }
}
