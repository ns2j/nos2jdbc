 ...
 * @author taedium
 */
public class SqlUnitExecutor {

    /** ロガー */
    protected static Logger logger = Logger
            .getLogger(SqlUnitExecutor.class);
     ...
     *            エラー発生時に処理を即座に中断する場合{@code true}、中断しない場合{@code false}
     */
    public SqlUnitExecutor(DataSource dataSource,
    ...
    protected SqlExecutionContext createSqlExecutionContext() {
        return new SqlExecutionContext(dataSource, userTransaction == null,
                haltOnError);
    }
