...
class GenerateSequenceTest {
    ...
    void testCreate() throws Exception {
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/create-sequence.ftl", "UTF-8", false);
    ...
    void testDrop() throws Exception {
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/drop-sequence.ftl", "UTF-8", false);
        generator.generate(context);
