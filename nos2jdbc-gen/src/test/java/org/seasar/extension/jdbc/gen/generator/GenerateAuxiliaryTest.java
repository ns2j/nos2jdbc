...
class GenerateAuxiliaryTest {
    ...
    void testCreate() throws Exception {
        ...
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/create-auxiliary.ftl", "UTF-8", false);
    ...
    void testDrop() throws Exception {
        ...
        TableModel model = factory.getTableModel(tableDesc);
        GenerationContext context = new GenerationContext(model, new File("file"), "sql/drop-auxiliary.ftl", "UTF-8", false);
        generator.generate(context);
        System.out.println(generator.getResult());
