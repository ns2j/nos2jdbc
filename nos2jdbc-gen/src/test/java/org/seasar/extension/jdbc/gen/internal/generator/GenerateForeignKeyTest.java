...
class GenerateForeignKeyTest {
    ...
    void testCreate() throws Exception {
        ...
        GenerationContext context = new GenerationContextImpl(model, new File("file"), "sql/create-foreignkey.ftl", "UTF-8", false);
    ...
    void testDrop() throws Exception {
        ...
        tableDesc.addForeignKeyDesc(foreignKeyDesc2);
        TableModel model = factory.getTableModel(tableDesc);
        GenerationContext context = new GenerationContextImpl(model, new File("file"), "sql/drop-foreignkey.ftl", "UTF-8", false);
        generator.generate(context);
